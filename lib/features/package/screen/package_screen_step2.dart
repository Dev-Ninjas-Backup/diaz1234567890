...
class PackageScreenStep2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.find<SellPackageController>();
    controller.scheduleStep2Initialization(Get.arguments);
                              ...
                              Expanded(
                                child: Obx(
                                  () => _buildDropdownField(
                                    label: 'Propeller Type:',
                                    value:
                                        controller.selectedPropellerType.value,
                                    hint: 'Select',
                                    items: controller.propellerTypes,
                                    ...
                                    Positioned(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          ...
                                          controller.existingCoverImages
                                              .clear();
                                        },
                                        child: Container(
                                          decoration: BoxDecoration(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      if (isExisting) {
                                        ...
                                        controller.existingGalleryImages
                                            .removeAt(index);
                                      } else {
