...
class SellPackageController extends GetxController {
      ...
      try {
        ...
        if (response['success'] == true) {
          ...
          if (data != null) {
            ...
            print('[DEBUG] Listing ID: ${listingId.value}');
            print('[DEBUG] Payment Intent ID: ${paymentIntentId.value}');
            print('[DEBUG] User ID: ${userId.value}');
            print('[DEBUG] =========================================\n');
          }
  ...
  Future<void> confirmPayment() async {
    ...
    try {
      ...
      print('[DEBUG] confirmPayment: User ID = ${userId.value}');
      print('[DEBUG] confirmPayment: Payment Intent Secret = ${paymentIntentClientSecret.value}');
      ...
      if (result['success'] == true) {
        print('[DEBUG] confirmPayment: Payment confirmed successfully');
        Get.snackbar(
          'Success',
      ...
      print('[DEBUG] confirmPayment: Payment error - $e');
    } finally {
      isLoading.value = false;
    }
  }
